namespace NServiceBus
{
    ...
    class HeartbeatServiceControlBackend
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            if (_receiveAddresses != null)
            {
                headers[Headers.ReplyToAddress] = _receiveAddresses.MainReceiveAddress;
            }
            ...
            var operation = new TransportOperation(outgoingMessage, new UnicastAddressTag(_destinationQueue), properties);
        ...
        readonly ReceiveAddresses _receiveAddresses;

        public HeartbeatServiceControlBackend(string destinationQueue, ReceiveAddresses receiveAddresses)
        {
