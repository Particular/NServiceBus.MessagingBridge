...
public class MessageShovelTests
{
    ...
    class FakeAddressMap : IAddressMap
    {
        readonly bool tryTranslateToTargetFindsAMatch;

        public FakeAddressMap(bool tryTranslateToTargetFindsAMatch) => this.tryTranslateToTargetFindsAMatch = tryTranslateToTargetFindsAMatch;
