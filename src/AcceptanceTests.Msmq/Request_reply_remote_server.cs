...
public class Request_reply_remote_server : BridgeAcceptanceTest
{
    [Test]
    public async Task Should_get_the_reply()
    {
        var ctx = await Scenario.Define<Context>()
                    ...
                    .WithBridge(bridgeConfiguration =>
                    {
                        ...
                        var replyReceivingEndpoint = new BridgeEndpoint(Conventions.EndpointNamingConvention(typeof(ReplyReceivingEndpoint)) + "@localhost");
